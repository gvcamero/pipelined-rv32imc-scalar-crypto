...
The master branch is intended to work out of the box with the **core** module.
The ext-memory branch is intended to work with the **core-extmem** module. Switch to this branch if you would like to work on the processor.
