...
module alu(
	...
	function [63:0] clmul;
	   ...
	   input [31:0] b;
	   begin
	       clmul = (b[0] ? {{32{1'b0}}, a} : {64{1'b0}}) ^
	               (b[1] ? {{31{1'b0}}, a, 1'b0} : {64{1'b0}}) ^
	               (b[2] ? {{30{1'b0}}, a, {2{1'b0}}} : {64{1'b0}}) ^
	               (b[3] ? {{29{1'b0}}, a, {3{1'b0}}} : {64{1'b0}}) ^
	               (b[4] ? {{28{1'b0}}, a, {4{1'b0}}} : {64{1'b0}}) ^
	               (b[5] ? {{27{1'b0}}, a, {5{1'b0}}} : {64{1'b0}}) ^
	               (b[6] ? {{26{1'b0}}, a, {6{1'b0}}} : {64{1'b0}}) ^
	               (b[7] ? {{25{1'b0}}, a, {7{1'b0}}} : {64{1'b0}}) ^
	               (b[8] ? {{24{1'b0}}, a, {8{1'b0}}} : {64{1'b0}}) ^
	               (b[9] ? {{23{1'b0}}, a, {9{1'b0}}} : {64{1'b0}}) ^
	               (b[10] ? {{22{1'b0}}, a, {10{1'b0}}} : {64{1'b0}}) ^
	               (b[11] ? {{21{1'b0}}, a, {11{1'b0}}} : {64{1'b0}}) ^
	               (b[12] ? {{20{1'b0}}, a, {12{1'b0}}} : {64{1'b0}}) ^
	               (b[13] ? {{19{1'b0}}, a, {13{1'b0}}} : {64{1'b0}}) ^
	               (b[14] ? {{18{1'b0}}, a, {14{1'b0}}} : {64{1'b0}}) ^
	               (b[15] ? {{17{1'b0}}, a, {15{1'b0}}} : {64{1'b0}}) ^
	               (b[16] ? {{16{1'b0}}, a, {16{1'b0}}} : {64{1'b0}}) ^
	               (b[17] ? {{15{1'b0}}, a, {17{1'b0}}} : {64{1'b0}}) ^
	               (b[18] ? {{14{1'b0}}, a, {18{1'b0}}} : {64{1'b0}}) ^
	               (b[19] ? {{13{1'b0}}, a, {19{1'b0}}} : {64{1'b0}}) ^
	               (b[20] ? {{12{1'b0}}, a, {20{1'b0}}} : {64{1'b0}}) ^
	               (b[21] ? {{11{1'b0}}, a, {21{1'b0}}} : {64{1'b0}}) ^
	               (b[22] ? {{10{1'b0}}, a, {22{1'b0}}} : {64{1'b0}}) ^
	               (b[23] ? {{9{1'b0}}, a, {23{1'b0}}} : {64{1'b0}}) ^
	               (b[24] ? {{8{1'b0}}, a, {24{1'b0}}} : {64{1'b0}}) ^
	               (b[25] ? {{7{1'b0}}, a, {25{1'b0}}} : {64{1'b0}}) ^
	               (b[26] ? {{6{1'b0}}, a, {26{1'b0}}} : {64{1'b0}}) ^
	               (b[27] ? {{5{1'b0}}, a, {27{1'b0}}} : {64{1'b0}}) ^
	               (b[28] ? {{4{1'b0}}, a, {28{1'b0}}} : {64{1'b0}}) ^
	               (b[29] ? {{3{1'b0}}, a, {29{1'b0}}} : {64{1'b0}}) ^
	               (b[30] ? {{2{1'b0}}, a, {30{1'b0}}} : {64{1'b0}}) ^
	               (b[31] ? {1'b0, a, {31{1'b0}}} : {64{1'b0}});
	   end
    endfunction
    
    wire [63:0] clmul_res = clmul(op_a, op_b);
